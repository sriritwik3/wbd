          ...
          <footer className="footer" style={{ flex: '1 100%' }}>
            <div className="footer__addr">
              ...
              <a
                ...
                href="#"
                style={{ fontStyle: 'normal', color: '#0ea0ff' }}
              >
                Email Us
              </a>
            </div>
            ...
            <ul className="footer__nav">
              <li className="nav__item" style={{ lineHeight: '2em' }}>
                ...
                <ul className="nav__ul">
                  <li>
                    {/* eslint-disable-next-line*/}
                    <a href="/newPost" style={{ color: '#999' }}>
                      Posts
                    </a>
                  </li>
                  ...
                  <li>
                    {/* eslint-disable-next-line*/}
                    <a href="/Aboutus" style={{ color: '#999' }}>
                      About Us
                    </a>
                  </li>
              ...
              <li
                className="nav__item__extra"
                style={{ lineHeight: '2em', flexGrow: '2' }}
              >
