      ...
      >
        ...
        >
          <div className={styles.row} style={{ marginBottom: '3rem' }}>
            <div className={styles.col_lg_6} style={{ order: '1', order: '2' }}>
              <i className="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
              <h2
                className="font-weight-light"
                style={{ fontWeight: 'lighter' }}
              >
                Intention behind project
              </h2>
              <p
                className={styles.text_muted}
                style={{ marginBottom: '1.5rem', fontStyle: 'italic' }}
              >
                We created the project to help people who need more manpower for
                their projects,teams and etc.
              </p>
              <a
                href="#"
          ...
          <div className={styles.row} style={{ marginBottom: '1.5rem' }}>
            <div className={styles.col_lg_5}>
              ...
              <p
                ...
                style={{ marginBottom: '1.5rem', fontStyle: 'italic' }}
              >
                This is the core team at proSpaces.
              </p>
            </div>
          </div>
          ...
          >
            <div className={styles.col_xl_3} style={{ marginBottom: '3rem' }}>
              ...
              >
                ...
                <h5 className="mb-0" style={{ marginBottom: '0' }}>
                  Dhiraj Kumar Chintada
                </h5>
                <span
                  className={styles.text_muted}
                  style={{ fontSize: '0.875em', textTransform: 'uppercase' }}
                >
                  Co-Founder
                </span>
              </div>
