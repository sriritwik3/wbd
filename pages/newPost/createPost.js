...
function CreatePost() {
  ...
  const [newpost, setNewpost] = useState({
    //hook to store data of the post i.e. created
    title: '',
    goal: '',
    description: '',
    membercount: 0,
  ...
  const handleinput = (e) => {
    //function to collect data from form and store in hook.
    let name, value;
    name = e.target.name;
  ...
  function taghandle(e) {
    //function to get the tag data(skills),convert it to an object and store in the hook
  ...
  const handlesubmit = async (e) => {
    //function that sends data to the firebase after submission.
    e.preventDefault();
    try {
      console.log(newpost);
      ...
      {user ? (
        <div className={styles.div}>
          <form onSubmit={handlesubmit}>
            ...
            <div className={styles.innerdiv}>
              ...
              <Tooltip
                color="primary"
                sx={{ width: '1.5rem', height: '1.5rem' }}
                title="Please add a goal for your post"
                arrow
              >
                <InfoOutlinedIcon />
              </Tooltip>
            ...
            <div className={styles.innerdiv}>
              ...
              <Tooltip
                color="primary"
                sx={{ width: '1.5rem', height: '1.5rem' }}
                title="Please add a description for your post"
                arrow
              >
                <InfoOutlinedIcon />
              </Tooltip>
            ...
            <div className={styles.innerdiv}>
              ...
              <Tooltip
                color="primary"
                sx={{ width: '1.5rem', height: '1.5rem' }}
                title="Please add the number of people you want in your team"
                arrow
              >
                <InfoOutlinedIcon />
              </Tooltip>
            ...
            <div className={styles.innerdiv}>
              ...
              <Tooltip
                color="primary"
                sx={{ width: '1.5rem', height: '1.5rem' }}
                title="Please add the number of weeks it takes for your project to complete"
                arrow
              >
                <InfoOutlinedIcon />
              </Tooltip>
            ...
            <div className={styles.innerdiv}>
              ...
              <Tooltip
                color="primary"
                sx={{ width: '1.5rem', height: '1.5rem' }}
                title="Please add the how much hours per week it takes for your project to complete"
                arrow
              >
                <InfoOutlinedIcon />
              </Tooltip>
            ...
            <div className={styles.innerdiv}>
              ...
              <Tooltip
                color="primary"
                sx={{ width: '1.5rem', height: '1.5rem' }}
                title="Please add the skills as comma seperated values"
                arrow
              >
                <InfoOutlinedIcon />
              </Tooltip>
          ...
          {success ? (
            ...
            >
              Your Post has been successfully posted, and you will be redirected
              to the post page in 2s
            </Alert>
          ) : (
            <div></div>
          )}
          ...
          {failure ? (
            ...
            >
              There was an Error while posting your Post
            </Alert>
          ) : (
            <div></div>
          )}
