                ...
                ( < div className = { styles.div } >
                    ...
                    /form> {
                        success ? ( < Alert onClose = {
                            () => { setSuccess(0) } } > Your Post has been successfully posted, and you will be redirected to the post page in 2 s < /Alert>) : ( < div > < /div>)}

                            {
                                failure ? ( < Alert severity = "error"
                                    onClose = {
                                        () => { setFailure(0) } } > There was an Error
                                    while posting your Post < /Alert>
                                ) : ( < div > < /div>)} <
                                    /div>
                                ): ( <
                                    Restricted / >
